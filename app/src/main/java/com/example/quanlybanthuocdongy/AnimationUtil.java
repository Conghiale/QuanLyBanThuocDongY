...
public class    AnimationUtil {
    ...
    public static void translateAnimation(final ImageView viewAnimation, @NonNull final View startView, View endView, final Animation.AnimationListener animationListener){
        ...
        float fromY = startPos[1] - startViewHeightCenter - 100;
